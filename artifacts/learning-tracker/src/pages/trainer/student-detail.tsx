...
export default function TrainerStudentDetailPage() {
  ...
  return (
    <Layout>
      <div data-testid="page-trainer-student-detail">
        <Button variant="ghost" className="mb-6" data-testid="btn-back" onClick={() => setLocation("/trainer/progress")}>
          ...
          <>
            <div className="mb-6 flex items-start justify-between flex-wrap gap-4">
              <div>
                ...
                <div className="text-muted-foreground text-sm mt-1">{data.student.phone}{data.student.timing ? ` · ${data.student.timing}` : ""}</div>
              ...
              <Button data-testid="btn-update" onClick={() => setLocation("/trainer/update")} size="sm">
                Update Progress
              </Button>
            </div>
